...
export default function Home(){return <main>
  ...
  <section className="plans-section" id="planos">
    ...
    <div className="pricing-grid">
      <article><span className="plan-label">30 DIAS</span><h3>Plano Domina</h3><div className="price"><small>R$</small><strong>49</strong><sup>90</sup></div><p>30 dias corridos de acesso ao Plano Domina.</p><a href="/api/mercadopago/checkout?plan=30d" className="plan-button">Quero participar <ArrowRight size={16}/></a></article>
      <article className="recommended"><span className="recommendation">MAIS ESCOLHIDO</span><span className="plan-label">90 DIAS</span><h3>Plano Domina</h3><div className="price"><small>R$</small><strong>129</strong><sup>90</sup></div><p>90 dias corridos de acesso. Ou 3 parcelas de R$ 43,30.</p><a href="/api/mercadopago/checkout?plan=90d" className="plan-button">Quero participar <ArrowRight size={16}/></a></article>
      <article><span className="plan-label">365 DIAS</span><h3>Plano Domina</h3><div className="price"><small>12x R$</small><strong>30</strong><sup>00</sup></div><p>R$ 360 por 365 dias corridos de acesso.</p><a href="/api/mercadopago/checkout?plan=annual" className="plan-button">Quero participar <ArrowRight size={16}/></a></article>
    </div>
    <div className="plan-features"><div><LockKeyhole size={19}/><span><b>O que o Plano Domina desbloqueia</b><small>Sem limitar o acesso aos simulados gratuitos.</small></span></div><ul>{planFeatures.map(item=><li key={item}><Check size={16}/>{item}</li>)}</ul></div>
    <p className="plans-note">Os acessos pagos têm duração determinada conforme o período escolhido. Os 25 usuários fundadores não cadastram cartão e não terão renovação automática ao fim do acesso gratuito.</p>
  </section>
