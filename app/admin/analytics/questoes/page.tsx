...
export default async function QuestionAnalyticsPage(){
  await requireAdminPermission("analytics:view","/admin/analytics/questoes");
  ...
  return <main className="admin-surface">
    ...
    <div className="admin-shell">
      <aside className="admin-sidebar"><nav aria-label="Navegação administrativa"><Link href="/admin/analytics"><ArrowLeft/>Analytics</Link><Link className="active" href="/admin/analytics/questoes"><BarChart3/>Qualidade</Link></nav></aside>
