...
export default function Plataforma(){return <main className="app-surface"><AppHeader active="inicio"/><div className="app-container diagnosis-demo">
  ...
  <section className="diagnosis-overview">
    <article className="main-score-card"><div className="score-context"><small>RESULTADO DO SIMULADO</small><div><strong>34</strong><span>/80</span></div><p>42,5% de aproveitamento</p></div><div className="approval-distance"><div><span>34 pontos</span><b>40 pontos</b><small>aprovação</small></div><i><em/><b/></i><p>Faltaram <strong>6 acertos</strong> para atingir a linha de aprovação.</p></div></article>
    <article className="readiness-card"><small>ÍNDICE DE PRONTIDÃO</small><div className="readiness-ring"><strong>63</strong><span>/100</span></div><h2>Preparação intermediária</h2><p>O desempenho já indica uma base aproveitável, mas ainda há oscilações em disciplinas estratégicas.</p></article>
