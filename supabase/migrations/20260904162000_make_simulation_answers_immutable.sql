-- Impede alteração de resposta já registrada em tentativa salva.
-- O front já bloqueia a UI após a correção; esta proteção torna a regra autoritativa no servidor.
